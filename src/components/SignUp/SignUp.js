        ...
        >
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              id="email"
              placeholder="email"
              className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-cyan-400"
              required
            />
          </div>
          <div className="space-y-1 text-sm">
          ...
          <div className="space-y-1 text-sm">
            <label
              htmlFor="confirm"
              className="block dark:text-gray-400 space-y-1"
            >
              Confirm Password
            </label>
            <input
